...
const Hero = () => (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts usesa methodology to identify the credit cards most likely to fit your needs. we examine annual percentage rates, annual fees. </p>
      </div>
